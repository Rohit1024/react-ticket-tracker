...
import { updateTicket } from "@/lib/ticket-api";
import {
  Card,
  CardHeader,
  CardTitle,
...
export function UpdateTicketComponent() {
  const [isCreatingPending, starCreatingTransition] = React.useTransition();
  const { state } = useLocation();
  const ticket = ticketSchema.parse(state);
  ...
  function onSubmit(input: createTicketSchemaType) {
    ...
    starCreatingTransition(() => {
      toast.promise(updateTicket(input), {
